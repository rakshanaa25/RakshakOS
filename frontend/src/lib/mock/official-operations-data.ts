...
export const mockFullAgentActivityEvents: FullAgentActivityEvent[] = [
  {
    ...
    category: 'REPLANNING',
    description: 'Response Plan V2 activated for INC-032 following road blockage.',
    timestamp: '14:34',
    status: 'COMPLETED',
    incidentId: 'INC-032',
    teamId: 'TEAM-09',
    actionPerformed: 'Alternative response route via Eastern Peripheral Highway selected (+14m detour).',
    trigger: 'Canal Road (Road R17) reported submerged under 1.4m water.',
    affectedTeamName: 'Rescue Team Alpha',
    affectedResources: ['Inflatable Boat 02', 'Medical Kit 04'],
  },
  {
    id: 'evt-202',
    eventType: 'ROUTE_ALTERED',
    category: 'MONITORING',
    description: 'Road R17 (Canal Road) reported blocked by observation loop.',
    timestamp: '14:31',
    status: 'COMPLETED',
    incidentId: 'INC-032',
    actionPerformed: 'Primary access vector marked IMPASSABLE in Hydro-Grid model.',
    trigger: 'Ground truth report #409 confirmed water depth exceeding vehicle limits.',
  },
  {
    id: 'evt-203',
    eventType: 'RESOURCE_ALLOCATED',
    category: 'ALLOCATION',
    description: 'Boat 02 & 50 First Aid Kits allocated to Rescue Team Alpha.',
    timestamp: '14:29',
    status: 'COMPLETED',
    incidentId: 'INC-032',
    teamId: 'TEAM-09',
    actionPerformed: 'Assets dispatched from Sector 1 Staging Depot inventory.',
    trigger: 'Team Alpha dispatch requirement confirmed.',
    affectedTeamName: 'Rescue Team Alpha',
    affectedResources: ['Inflatable Boat 02', '50 First Aid Kits'],
  },
  {
    id: 'evt-204',
    eventType: 'TEAM_ASSIGNED',
    category: 'EXECUTION',
    description: 'Rescue Team Alpha (NDRF Unit) dispatched to INC-032.',
    timestamp: '14:26',
    status: 'COMPLETED',
    incidentId: 'INC-032',
    teamId: 'TEAM-09',
    actionPerformed: 'Team Alpha status updated to DEPLOYED / EN_ROUTE.',
    trigger: 'INC-032 severity rating CRITICAL.',
    affectedTeamName: 'Rescue Team Alpha',
  },
  {
    id: 'evt-205',
    ...
    category: 'PLANNING',
    description: 'Response Plan V1 created for INC-032.',
    timestamp: '14:22',
    status: 'COMPLETED',
    incidentId: 'INC-032',
    actionPerformed: 'Initial dispatch plan generated targeting North Canal residential block.',
    trigger: 'Incident #302 verified by observation loop.',
  },
  {
    id: 'evt-206',
    ...
    status: 'COMPLETED',
    incidentId: 'INC-032',
    actionPerformed: 'Priority level set to CRITICAL; hydro-agent dispatch queued.',
  ...
  },
  {
    ...
    incidentId: 'INC-029',
    teamId: 'TEAM-14',
    actionPerformed: 'Amphibious Medical Transporter dispatched to East Junction.',
  ...
  },
  {
    ...
    eventType: 'RESOURCE_ALLOCATED',
    category: 'ALLOCATION',
    description: 'Dewatering Pump 01 allocated to Substation #3 perimeter (INC-027).',
    timestamp: '13:45',
    status: 'COMPLETED',
    incidentId: 'INC-027',
    teamId: 'TEAM-03',
...
export const mockDetailedTeams: ResponseTeamItem[] = [
  ...
  },
  {
    ...
    equipment: ['Amphibious Medical Ambulance', 'Defibrillator', 'Trauma Kits'],
  },
  {
    id: 'TEAM-04',
    code: 'TEAM-04',
...
export const mockHumanApprovalsList: HumanAttentionItem[] = [
  ...
  {
    id: 'APP-011',
    title: 'Reallocate Dewatering Pump 02 from Reserve Stockpile',
    ...
    requestingAgent: 'Strands-ResourceAgent-01',
    timestamp: '14:15:30',
  ...
  },
  {
    ...
    requestingAgent: 'Strands-DispatchAgent-03',
    timestamp: '13:50:00',
...
export const mockContactsDirectory: DetailedContact[] = [
  {
    ...
    currentMission: 'INC-032: North Canal Rescue',
...
export const mockBroadcastFeed: OperationalBroadcastMessage[] = [
  {
    ...
    message: 'Advisory: Bridge 2 arterial is impassable due to 1.4m flooding. All Sector 4 dispatches rerouted via Eastern Highway.',
    timestamp: '14:35',
