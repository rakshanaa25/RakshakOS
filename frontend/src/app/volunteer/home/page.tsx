...
export default function VolunteerHomePage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto px-4 md:px-6 py-6 font-sans">
      {/* Top Welcome Header */}
      <div className="bg-white border border-slate-200 rounded-xl p-5 md:p-6 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
      ...
      <Card className="p-4 border-amber-200 bg-amber-50/70 text-amber-950 shadow-xs flex items-start gap-3">
