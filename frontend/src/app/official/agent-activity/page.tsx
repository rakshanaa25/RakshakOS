    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans flex flex-col antialiased">
      ...
      <main className="flex-1 p-4 md:p-6 space-y-6 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <Card className="p-4 border-slate-200 bg-white shadow-xs">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Re-Plans Triggered</span>
              <RefreshCw className="w-4 h-4 text-amber-600" />
            </div>
            <p className="text-2xl font-bold text-amber-700 mt-2">4</p>
          ...
          <Card className="p-4 border-slate-200 bg-white shadow-xs">
            ...
            <span className="text-[11px] text-purple-700 font-medium font-mono">Strands Multi-Agent Loop</span>
          </Card>
          ...
          <Card className="p-4 border-slate-200 bg-white shadow-xs">
            ...
            <p className="text-2xl font-bold text-emerald-700 mt-2">1.2s</p>
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto pb-1 text-xs">
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-md font-semibold text-xs transition-colors whitespace-nowrap cursor-pointer ${
            ...
            filteredEvents.map((evt) => (
              ...
              >
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs text-slate-700 bg-slate-50 p-2.5 rounded-md border border-slate-200/80 leading-relaxed font-sans">
