        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <Card className="p-4 border-slate-200 bg-white shadow-xs">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Pending Authorizations</span>
          ...
          <Card className="p-4 border-slate-200 bg-white shadow-xs">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Rejected / Modified</span>
              <XCircle className="w-4 h-4 text-slate-500" />
            </div>
            <p className="text-2xl font-bold text-slate-800 mt-2">{rejectedCount}</p>
            <span className="text-[11px] text-slate-500">Overridden or adjusted</span>
          </Card>

          <Card className="p-4 border-slate-200 bg-white shadow-xs">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Control Protocol</span>
        ...
        <div className="space-y-4">
          {filteredItems.length === 0 ? (
            ...
            filteredItems.map((item) => (
              <Card
                key={item.id}
                className={`p-5 border bg-white shadow-xs space-y-4 transition-all ${
                  item.status === 'PENDING'
