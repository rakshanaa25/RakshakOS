...
export const TeamMemberManualForm: React.FC<TeamMemberManualFormProps> = ({
  ...
  return (
    <form onSubmit={handleAdd} className="p-4 rounded-md border border-slate-200 bg-slate-50 space-y-4 font-sans text-xs">
      ...
      <div className="flex justify-end pt-1">
        <Button type="submit" size="sm" className="bg-slate-900 hover:bg-slate-800 text-white gap-1.5">
          <Plus size={14} />
